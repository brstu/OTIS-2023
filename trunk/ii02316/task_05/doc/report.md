...
При выполнении 4 лабораторной работы столкнулся с ошибкой в проекте NIKA на странице sc-web (localhost:8000), о чем и сообщил в репозитории проекта: https://github.com/ostis-apps/nika/issues/303 и https://github.com/ostis-apps/nika/issues/304
