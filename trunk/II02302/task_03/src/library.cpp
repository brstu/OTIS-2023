...
bool Gamilton(int**& matrix, int*& path,int*& f, int vertexCount, int k, int v0)//начальна€ вершина
{
    bool res = false;
    for (int i = 0; i < vertexCount; i++)
    {
...
void Euler(int**& matrix, vector<int>& path, int vertexCount)//начальна€ вершина
{
...
//            if (low[i] >= disc[v])
//            {
//                cout << "Ќова€ компонента двусв€зности: ";
