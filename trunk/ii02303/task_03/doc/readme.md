...
Вывод: Я создал и внедрил программный продукт, который позволяет выполнять разнообразные операции над различными графовыми конструкциями.Итог проделанной работы отаброжен в скриншотах.В процессе работы с QT Creator я приобрел основные навыки,знания и приобрёл новый опыт.
