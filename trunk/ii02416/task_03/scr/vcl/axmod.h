/////////////////////////////////////////////////////////////////////////////
// AXMOD.H - COM/ActiveX Module Wrapper Classes
//
// $Rev: 86686 $
//
...
bool __fastcall TATLModule<T>::AutomationTerminateProc()
{
  ...
  if (_Module.GetLockCount() > 0)
  {
    ...
    return ::MessageBoxA(0, 
                         (System_Win_ComconstSNoCloseActiveServer1 + 
                          System_Win_ComconstSNoCloseActiveServer2).c_str(),
                         System_Win_ComconstSAutomationWarning.c_str(),
                         MB_YESNO|MB_TASKMODAL|MB_ICONWARNING|MB_DEFBUTTON2) == IDYES;
#else
    return ::MessageBoxW(0, 
                        (System_Win_ComconstSNoCloseActiveServer1 + 
                         System_Win_ComconstSNoCloseActiveServer2).c_str(),
                        System_Win_ComconstSAutomationWarning.c_str(),
                        MB_YESNO|MB_TASKMODAL|MB_ICONWARNING|MB_DEFBUTTON2) == IDYES;
...
HRESULT TRegistrarBaseT<T>::NukeRegKey(LPCTSTR keyStr)
{
  ...
  // NOTE: It's safe to close HKEY_CLASSES_ROOT here
}
