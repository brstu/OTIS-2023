...
{
	int red = StrToInt(Form5->Edit2->Text);
	int green = StrToInt(Form5->Edit3->Text);
	int blue = StrToInt(Form5->Edit4->Text);
	...
	graph[index_a][index_b].first = StrToInt(Form5->Edit1->Text);
	graph[index_b][index_a].first = StrToInt(Form5->Edit1->Text);
   ...
   for(int i=0;i<edges.size();i++)
   {
		if(index==i)
		{
			...
			edges[i].weight = StrToInt(Form5->Edit1->Text);
		}
