...
```Python
    ...
    ed1.show()
```
![Вывод:](trunk/ii02304/task_03/doc/screen1.png)

```Python
    button1 = alg_buttons(ed1, G1)
    button1
```
![Вывод:](trunk/ii02304/task_03/doc/screen2.png)
...
```Python
    ...
    ed2.show()
```
![Вывод:](trunk/ii02304/task_03/doc/screen3.png)
...
```Python
    ...
    ed3.show()
```
![Вывод:](trunk/ii02304/task_03/doc/screen4.png)
...
```Python
    ...
    ed4.show()
```
![Вывод:](trunk/ii02304/task_03/doc/screen5.png)