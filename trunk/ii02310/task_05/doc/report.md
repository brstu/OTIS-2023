...
Также предложил новую функциональность для программы NIKA.

![issue](0.png)

- также нашел нефункционирующую кнопку sc-web клиента, указав её [тут](https://github.com/ostis-apps/nika/issues/327)
