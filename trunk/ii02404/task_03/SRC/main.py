...
class GraphEditor:
    ...
    def add_edge(self):
        edge_start = tk.simpledialog.askstring("Add Edge", "Enter Start Vertex Label:")
        edge_end = tk.simpledialog.askstring("Add Edge", "Enter End Vertex Label:")
        edge_length = tk.simpledialog.askfloat("Add Edge", "Enter Edge Length:")
        if edge_start and edge_end and edge_length:
            self.graph.add_edge(edge_start, edge_end, length=edge_length)
            self.draw_graph()

    def choose_color(self):
        selected_vertex = tk.simpledialog.askstring("Choose Color", "Enter Vertex Label:")
        if selected_vertex:
    ...
    def shortest_path(self):
        try:
            start_vertex = tk.simpledialog.askstring("Shortest Path", "Enter Start Vertex Label:")
            end_vertex = tk.simpledialog.askstring("Shortest Path", "Enter End Vertex Label:")
