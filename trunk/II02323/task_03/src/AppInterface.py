...
def create_buttons(root, menu_add_vertex, menu_add_edge_window, eulerian_cycle_search_function, shortest_path):
    # List of Buttons
    add-vertex-button = Button(root, text="Добавить вершину", anchor="w", command=menu_add_vertex, font=('Arial', 9), width=15, bg='lightblue', fg='black')
    add-edges-button = Button(root, text="Добавить ребро", anchor="w", command=menu_add_edge_window, font=('Arial', 9), width=15, bg='lightblue', fg='black')
    euler-cycle-find-button = Button(root, text="Эйлеров цикл", anchor="w", command=eulerian_cycle_search_function, font=('Arial', 9), width=15, bg='lightblue', fg='black')
    shortest-way-find-button = Button(root, text="Кратчайший путь", anchor="w", command=shortest_path, font=('Arial', 9), width=15, bg='lightblue', fg='black')
    ...
    add-vertex-button.grid(row=1, column=0, sticky="ew", padx=10, pady=5)
    add-edges-button.grid(row=2, column=0, sticky="ew", padx=10, pady=5)
    euler-cycle-find-button.grid(row=3, column=0, sticky="ew", padx=10, pady=5)
    shortest-way-find-button.grid(row=4, column=0, sticky="ew", pady=5, padx=10)
